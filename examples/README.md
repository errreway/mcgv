...
Make sure you built them before start playing with the Examples. You can do it running the following command from the root of the project:
```shell
make build-java
```

All Ignite Go Client Examples requires Ignite cluster to be up and running locally. Ignite Go Client used in examples
will try to connect Ignite cluster using the default address - localhost:10800.
